...
namespace Appfinal
{
    ...
    public sealed partial class ItemsPage : Page
    {
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (groupId.ToString().Equals("Group-1"))
            {
                this.Frame.Navigate(typeof(MainPage), groupId);
            }
            if (groupId.ToString().Equals("Group-3"))
            {
                this.Frame.Navigate(typeof(ShowPlanPage), groupId);
            }
